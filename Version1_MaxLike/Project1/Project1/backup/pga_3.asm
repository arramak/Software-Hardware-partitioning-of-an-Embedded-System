...
IF (PGA_3_AGNDBUFAPI)
export  PGA_3_EnableAGNDBuffer
export _PGA_3_EnableAGNDBuffer
export  PGA_3_DisableAGNDBuffer
export _PGA_3_DisableAGNDBuffer
ENDIF
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PGA_3_EnableAGNDBuffer
;
;  DESCRIPTION:
...
;    functions.
;
 PGA_3_EnableAGNDBuffer:
_PGA_3_EnableAGNDBuffer:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   reg[PGA_3_GAIN_CR3], ~AGNDBUFMASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PGA_3_DisableAGNDBuffer
;
;  DESCRIPTION:
...
;    functions.
;
 PGA_3_DisableAGNDBuffer:
_PGA_3_DisableAGNDBuffer:
   RAM_PROLOGUE RAM_USE_CLASS_1
   or    reg[PGA_3_GAIN_CR3], AGNDBUFMASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
ENDIF
