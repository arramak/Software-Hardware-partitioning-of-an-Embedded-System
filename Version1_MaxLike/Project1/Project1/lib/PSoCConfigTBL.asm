...
;       Instance name DUALADC, Block Name ADC1(ASD20)
	db		90h, 90h		;DUALADC_bfADC1cr0(ASD20CR0)
	db		91h, a0h		;DUALADC_bfADC1cr1(ASD20CR1)
	db		92h, 61h		;DUALADC_bfADC1cr2(ASD20CR2)
	db		93h, f0h		;DUALADC_bfADC1cr3(ASD20CR3)
;       Instance name DUALADC, Block Name ADC2(ASD22)
	db		98h, 90h		;DUALADC_bfADC2cr0(ASD22CR0)
	db		99h, a0h		;DUALADC_bfADC2cr1(ASD22CR1)
	db		9ah, 60h		;DUALADC_bfADC2cr2(ASD22CR2)
	db		9bh, f0h		;DUALADC_bfADC2cr3(ASD22CR3)
;       Instance name DUALADC, Block Name CNT1(DBB10)
	db		33h, 00h		;DUALADC_bCounter1_CR0(DBB10CR0)
	db		31h, 00h		;DUALADC_bPeriod1(DBB10DR1)
	db		32h, 00h		;DUALADC_bCompare1(DBB10DR2)
;       Instance name DUALADC, Block Name CNT2(DBB11)
	db		37h, 00h		;DUALADC_bCounter2_CR0(DBB11CR0)
	db		35h, 00h		;DUALADC_bPeriod2(DBB11DR1)
	db		36h, 00h		;DUALADC_bCompare2(DBB11DR2)
;       Instance name DUALADC, Block Name PWM16_LSB(DCB12)
	db		3bh, 00h		;DUALADC_fPWM_LSB_CR0(DCB12CR0)
	db		39h, 00h		;DUALADC_bPWM_Period_LSB(DCB12DR1)
	db		3ah, 00h		;DUALADC_bPWM_IntTime_LSB(DCB12DR2)
;       Instance name DUALADC, Block Name PWM16_MSB(DCB13)
	db		3fh, 00h		;DUALADC_fPWM_MSB_CR0(DCB13CR0)
	db		3dh, 00h		;DUALADC_bPWM_Period_MSB(DCB13DR1)
	db		3eh, 00h		;DUALADC_bPWM_IntTime_MSB(DCB13DR2)
;  Instance name LCD, User Module LCD
;  Instance name LPF2_1, User Module LPF2
;       Instance name LPF2_1, Block Name FLIN(ASC12)
	db		88h, a0h		;LPF2_1_FLIN_CR0(ASC12CR0)
	db		89h, 80h		;LPF2_1_FLIN_CR1(ASC12CR1)
	db		8ah, 00h		;LPF2_1_FLIN_CR2(ASC12CR2)
	db		8bh, 24h		;LPF2_1_FLIN_CR3(ASC12CR3)
;       Instance name LPF2_1, Block Name FLOUT(ASD13)
	db		8ch, 80h		;LPF2_1_FLOUT_CR0(ASD13CR0)
	db		8dh, 40h		;LPF2_1_FLOUT_CR1(ASD13CR1)
	db		8eh, 80h		;LPF2_1_FLOUT_CR2(ASD13CR2)
	db		8fh, 20h		;LPF2_1_FLOUT_CR3(ASD13CR3)
;  Instance name LPF2_3, User Module LPF2
;       Instance name LPF2_3, Block Name FLIN(ASC10)
	db		80h, 94h		;LPF2_3_FLIN_CR0(ASC10CR0)
	db		81h, 88h		;LPF2_3_FLIN_CR1(ASC10CR1)
	db		82h, 00h		;LPF2_3_FLIN_CR2(ASC10CR2)
	db		83h, 24h		;LPF2_3_FLIN_CR3(ASC10CR3)
;       Instance name LPF2_3, Block Name FLOUT(ASD11)
	db		84h, 92h		;LPF2_3_FLOUT_CR0(ASD11CR0)
	db		85h, 40h		;LPF2_3_FLOUT_CR1(ASD11CR1)
	db		86h, 9fh		;LPF2_3_FLOUT_CR2(ASD11CR2)
	db		87h, 20h		;LPF2_3_FLOUT_CR3(ASD11CR3)
...
;       Instance name PGA_3, Block Name GAIN(ACB02)
	db		79h, 0dh		;PGA_3_GAIN_CR0(ACB02CR0)
...
;       Instance name PGA_4, Block Name GAIN(ACB03)
	db		7dh, 0dh		;PGA_4_GAIN_CR0(ACB03CR0)
...
;       Instance name Timer, Block Name TIMER16_LSB(DBB00)
	...
	db		21h, 40h		;Timer_PERIOD_LSB_REG(DBB00DR1)
	db		22h, 00h		;Timer_COMPARE_LSB_REG(DBB00DR2)
;       Instance name Timer, Block Name TIMER16_MSB(DBB01)
	db		27h, 04h		;Timer_CONTROL_MSB_REG(DBB01CR0)
	db		25h, 1fh		;Timer_PERIOD_MSB_REG(DBB01DR1)
...
;       Instance name DUALADC, Block Name ADC2(ASD22)
;       Instance name DUALADC, Block Name CNT1(DBB10)
	db		30h, 21h		;DUALADC_fCounter1FN(DBB10FN)
	db		31h, 45h		;DUALADC_fCounter1SL(DBB10IN)
	db		32h, 40h		;DUALADC_fCounter1OS(DBB10OU)
;       Instance name DUALADC, Block Name CNT2(DBB11)
	db		34h, 21h		;DUALADC_fCounter2FN(DBB11FN)
	db		35h, 65h		;DUALADC_fCounter2SL(DBB11IN)
	db		36h, 40h		;DUALADC_fCounter2OS(DBB11OU)
;       Instance name DUALADC, Block Name PWM16_LSB(DCB12)
	db		38h, 01h		;DUALADC_bfPWM_LSB_FN(DCB12FN)
	db		39h, 15h		;DUALADC_(DCB12IN)
	db		3ah, 40h		;DUALADC_(DCB12OU)
;       Instance name DUALADC, Block Name PWM16_MSB(DCB13)
	db		3ch, 21h		;DUALADC_bfPWM_MSB_FN(DCB13FN)
	db		3dh, 35h		;DUALADC_(DCB13IN)
	db		3eh, 40h		;DUALADC_(DCB13OU)
;  Instance name LCD, User Module LCD
;  Instance name LPF2_1, User Module LPF2
;       Instance name LPF2_1, Block Name FLIN(ASC12)
;       Instance name LPF2_1, Block Name FLOUT(ASD13)
...
;  Global Register values Bank 1
	...
	db		62h, 58h		; AnalogIOControl_0 register (ABF_CR0)
